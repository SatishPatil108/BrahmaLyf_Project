...
import { Music, Plus, SquarePen, Trash2, Play, Pause, AlertCircle, CheckCircle, Volume2, Globe } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Music Library</h1>
                            <p className="text-sm text-gray-600 dark:text-gray-400">Manage your music collection</p>
                        </div>
                    </div>
                ...
                {loading && (
                    <div className="flex flex-col items-center justify-center py-16">
                        ...
                        <p className="text-lg font-medium text-gray-600 dark:text-gray-400">Loading music library...</p>
                        <p className="text-sm text-gray-500 dark:text-gray-500 mt-2">Please wait while we fetch your songs</p>
                    </div>
                )}
                ...
                {error && !loading && (
                    <div className="flex flex-col items-center justify-center py-16">
                        ...
                        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Failed to Load Music</h2>
                    ...
                    <>
                        ...
                        {audiosDetails.total_pages > 1 && (
                            <div className="mt-8 flex justify-center">
                                <Pagination currentPage={pageNo} totalPages={audiosDetails.total_pages} onPageChange={setPageNo} />
                            </div>
                        )}
                    </>
                )}
                ...
                {!loading && !error && musics.length === 0 && (
                    <div className="text-center py-16 border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-2xl bg-white dark:bg-gray-900">
                        ...
                        <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2">No Music Found</h3>
                        <p className="text-gray-500 dark:text-gray-400 mb-6">Get started by adding your first song to the library</p>
                    ...
                    <div className="flex-1 overflow-y-auto px-4 py-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    if (errors.songName) setErrors((p) => ({ ...p, songName: null }));
                                }}
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={(e) => {
                                    ...
                                    if (errors.songInfo) setErrors((p) => ({ ...p, songInfo: null }));
                                }}
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => {
                                    ...
                                    if (errors.songCategory) setErrors((p) => ({ ...p, songCategory: null }));
                                }}
                            ...
                            {errors.songCategory && (
                                <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.songCategory}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <FileUploaderWithPreview
                                ...
                                setImageFile={(file) => {
                                    ...
                                    if (errors.songThumbnail) setErrors((p) => ({ ...p, songThumbnail: null }));
                                }}
                        ...
                        <div>
                            ...
                            <AudioUploaderWithPreview
                                ...
                                setAudioFile={(file) => {
                                    setSongFile(file);
                                    if (errors.songFile) setErrors((p) => ({ ...p, songFile: null }));
                                }}
