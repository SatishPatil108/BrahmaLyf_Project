        ...
        <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-2xl p-6">
          <div className="space-y-4">
            <div>
              ...
              <p className="mt-2 text-gray-900 dark:text-gray-100 text-lg">
            ...
            <div className="space-y-3">
              {questions.map((tool, index) => (
                <div
                  ...
                  onClick={() => handleViewQuestion(tool)}
                >
                  <div className="p-4">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-2 ml-4">
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            onDeleteQuestion(tool.tools_question_id);
                          }}
...
const ProgressToolsQuestionDetails = ({
  ...
  const validate = () => {
    ...
    } else if (formData.tools_question.length < 3) {
