...
// Component for Message List Drawer
const MessageListDrawer = ({
  ...
  return (
    <>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Manage all your weekly progress messages
              </p>
            </div>
          </div>
        }
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-2xl p-4">
            ...
            <div className="mt-3 text-xs text-gray-500 dark:text-gray-400">
              Showing messages for Week {localWeekNo}
            </div>
          </div>
          ...
          {messages.length === 0 ? (
            <div className="text-center py-12 border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-2xl">
              ...
              <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">
                No messages available for Week {localWeekNo}
              </p>
      ...
      {/* View Message Details Drawer (Nested) */}
      <ViewMessageDrawer
...
// Main Component
const ProgressMessageDetails = ({ isOpen, onClose, drawerOnly = false }) => {
    ...
    return (
      <>
        <MessageListDrawer
          ...
          messages={messages}
          onEditMessage={openEditMessageForm}
          onDeleteMessage={handleDelete}
          onAddMessage={openAddMessageForm}
        ...
        {!loading && !error && (
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-3">
              Click "Manage Messages" to view, add, edit, or delete progress
