...
const DomainsList = () => {
  ...
  const handleDeleteDomain = async (domain) => {
    if (
      window.confirm(`Are you sure you want to delete "${domain.domain_name}"?`)
    ) {
            ...
            <div>
              ...
              <FileUploaderWithPreview
                ...
                setImageFile={(file) => {
                  ...
                  if (errors.domainThumbnail)
                    setErrors((p) => ({ ...p, domainThumbnail: null }));
                }}
