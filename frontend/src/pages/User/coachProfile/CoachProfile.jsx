...
const CoachProfile = () => {
  ...
  return (
    <div
      className={`min-h-screen ${theme === "dark" ? "bg-gray-900" : "bg-gray-50"} py-8 px-4`}
    >
      <div className="max-w-6xl mx-auto">
        {/* Main Profile Card */}
        <div
          className={`rounded-2xl shadow-xl overflow-hidden mb-8 ${theme === "dark" ? "bg-gray-800" : "bg-white"}`}
        >
            ...
            <div className="md:w-2/3 p-6 md:p-8">
              <div className="mb-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  <div>
                    <h1
                      className={`text-3xl md:text-4xl font-bold ${theme === "dark" ? "text-white" : "text-gray-900"}`}
                    >
                      {coachProfile.name}
                    </h1>
                    <p
                      className={`text-lg md:text-xl mt-2 ${theme === "dark" ? "text-indigo-400" : "text-indigo-600"}`}
                    >
              ...
              <div>
                ...
                <div
                  className={`p-6 rounded-xl ${theme === "dark" ? "bg-gray-700/50" : "bg-gray-50"}`}
                >
                  <p
                    className={`leading-relaxed ${theme === "dark" ? "text-gray-300" : "text-gray-700"}`}
                    dangerouslySetInnerHTML={{
                      __html: coachProfile.bio,
                    }}
                  />
                </div>
              </div>
        ...
        >
          <h2
            className={`text-2xl font-bold mb-6 ${theme === "dark" ? "text-white" : "text-gray-900"} text-center`}
          >
