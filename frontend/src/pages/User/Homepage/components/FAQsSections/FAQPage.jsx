          ...
          <div className="text-center mb-12">
            ...
            >
              <span className="text-sm font-medium">
                {allFAQs.length}{" "}
                {allFAQs.length === 1 ? "question" : "questions"} loaded •{" "}
                {totalFAQs} total
              </span>
            </div>
            ...
            <div className="max-w-md mx-auto mb-8">
              ...
              >
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-10 py-4 focus:outline-none ${
                    theme === "dark"
              ...
              {filteredFAQs.map((faq, index) => (
                ...
                >
                  <button
                    ...
                    className={`w-full p-4 sm:p-5 text-left flex items-center justify-between gap-4 transition-all duration-300 ${
                      openIndex === index
                        ? theme === "dark"
                          ? "bg-purple-900/20"
                          : "bg-purple-50"
                  ...
                  <AnimatePresence>
                    {openIndex === index && (
                      ...
                      >
                        <div
                          className={`p-4 sm:p-5 pt-0 pl-14 ${
                            theme === "dark" ? "text-gray-300" : "text-gray-600"
                          }`}
                        >
                          <div
          ...
          {!loading && !error && !searchQuery && hasNextPage && (
            <div className="mt-8 flex flex-col items-center">
              <button
                ...
                disabled={loading}
                className={`px-6 py-3 rounded-full flex items-center gap-3 transition-all hover:scale-105 ${
                  theme === "dark"
