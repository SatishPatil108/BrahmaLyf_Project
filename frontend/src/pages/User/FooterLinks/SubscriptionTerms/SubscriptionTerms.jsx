  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700">
                All subscriptions are subject to the strict No Refund and No
                Cancellation policy. Please review all terms carefully before
          ...
          <div className="space-y-5">
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <span className="text-slate-700 group-hover:text-slate-900 transition-colors">
                ...
                <span className="font-semibold">Subscription Terms</span>{" "}
                outlined above
              </span>
            </label>
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <span className="text-slate-700 group-hover:text-slate-900 transition-colors">
                ...
                <span className="font-semibold">
                  share my account credentials
                </span>{" "}
                and understand this subscription is for{" "}
                <span className="font-semibold">one user only</span>
              </span>
            </label>
          </div>
        </div>
        ...
        {/* Footer Note */}
        <div className="mt-10 mb-24 rounded-xl bg-emerald-50 border border-emerald-200 p-6 text-center">
          <p className="text-sm text-slate-700">
            By accepting these Subscription Terms, you confirm that you have
            read, understood, and agree to be bound by all terms and conditions.
            These terms may be updated periodically, and continued use
