...
export const fetchSubDomains = async (pageNo, pageSize, domainId) => {
  return await makeRequest({
...
export const fetchInquiries = async (pageNo, pageSize) => {
  return await makeRequest({
    service: `admin/inquiries/${pageNo}/${pageSize}`,
    method: API_METHODS.GET,
    authRequired: true,
    tokenType: "admin",
  });
...
export const sendReply = async (inquiry_id, formData) => {
  return await makeRequest({
    service: `admin/inquiry/reply/${inquiry_id}`,
    method: API_METHODS.POST,
    data: formData,
    authRequired: true,
    tokenType: "admin",
...
export const postProgressToolsQuestion = async ({ courseId, questionData }) => {
  return await makeRequest({
    service: `admin/progress-tools/questions/${courseId}`,
    method: API_METHODS.POST,
    data: questionData,
    authRequired: true,
    tokenType: "admin",
...
export const updateProgressToolsQuestion = async ({
  tools_question_id,
  courseId,
  questionData,
}) => {
  return await makeRequest({
    service: `admin/progress-tools/questions/${courseId}/${tools_question_id}`,
    method: API_METHODS.PUT,
    data: questionData,
    authRequired: true,
    tokenType: "admin",
